        ...
        <div className="sidebar-footer">
          {isOpen && (
            <div className="user-info">
              <NavLink to="/app/profile" className="avatar-link" title="Profile">
                {user?.avatar_url ? (
                  <div className="avatar"><img src={user.avatar_url} alt="User" style={{ width: '100%', height: '100%', borderRadius: '50%', objectFit: 'cover' }} /></div>
                ) : (
                  <div className="avatar">{user?.first_name?.charAt(0) || 'U'}</div>
                )}
              </NavLink>
